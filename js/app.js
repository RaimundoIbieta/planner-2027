...
function eventList(date) {
  ...
  const gcalHint = gcalEnabled()
    ...
    : `<p class="hint">La primera vez, Google pedirá permiso. Después queda enlazado.</p>`;
...
function renderProfile() {
  ...
  return `<section class="sheet">
    ...
    <div class="box" style="margin-top:10px">
      ...
      ${
        gcalEnabled()
          ? `<p class="hint">Enlazado. Un evento que agregues en el planner aparece también en Google Calendar. No hace falta volver a conectar al entrar.</p>`
          : `<p class="hint">Una sola vez: pega la llave de Google (termina en <code>.apps.googleusercontent.com</code>) y entra con tu Gmail. Después no se vuelve a pedir.</p>
      <label class="field-label" for="gcal-client">Llave de Google</label>
      ...
      <div class="actions" style="margin-top:10px">
        ...
        <button class="btn primary" type="button" data-act="gcal-connect">Enlazar Calendar</button>
      </div>`
      }
    </div>
    <div class="actions">
